...
class Normalizer
{
    ...
    const REMOVE_USER_INFO = 1;
    const CONVERT_HOST_UNICODE_TO_PUNYCODE = 2;
    const REMOVE_FRAGMENT = 4;
    const REMOVE_WWW = 8;
    const REMOVE_PATH_DOT_SEGMENTS = 16;
    const ADD_PATH_TRAILING_SLASH = 32;
    const SORT_QUERY_PARAMETERS = 64;
    const REDUCE_DUPLICATE_PATH_SLASHES = 128;
    const DECODE_UNRESERVED_CHARACTERS = 256;
    const REMOVE_DEFAULT_PORT = 512;
    const CAPITALIZE_PERCENT_ENCODING = 1024;
    const CONVERT_EMPTY_HTTP_PATH = 2048;
    const REMOVE_DEFAULT_FILE_HOST = 4096;
